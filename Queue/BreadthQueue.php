...
/**
 * A first in first out (FIFO) queue to traverse a webpage breadth-first.
 *
 * Class BreadthQueue created on 2018-03-14.
 *
 * @author  Konstantin Simon Maria Möllers
 * @package Baqend\Component\Spider\Queue
 */
class BreadthQueue implements QueueInterface
{
